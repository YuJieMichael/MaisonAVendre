...
export const enquiryOptions = {
  en: {
    ...
    contact: 'Contact preferences · optional', language: 'Preferred language', method: 'Preferred contact method', none: 'No preference', email: 'Email', phone: 'Phone', availability: 'Convenient contact times', timeHint: 'For example: weekdays after 6 pm, Montréal time.', phoneHint: 'If you prefer a call, you can add your number above. Otherwise we can reach you by email.',
  },
  fr: {
  ...
  zh: {
    ...
    contact: '联系偏好 · 选填', language: '希望使用的语言', method: '偏好的联系方式', none: '无偏好', email: '邮件', phone: '电话', availability: '方便联系的时间', timeHint: '例如：工作日晚上 6 点后，蒙特利尔时间。', phoneHint: '如果希望电话联系，可以在上方留下号码；未填号码时，我们可以通过邮箱联系您。',
  },
};
